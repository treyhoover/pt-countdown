...
export const schedule: Schedule = {
  ...
  sessions: [
    ...
    { month: "Dezembro", day: 9, session: 10, hours: 4 },
    { month: "Dezembro", day: 10, session: 11, hours: 4 },
    { month: "Dezembro", day: 11, session: 12, hours: 4 },
    { month: "Dezembro", day: 12, session: 13, hours: 4 },
    { month: "Dezembro", day: 13, session: 14, hours: 4 },
